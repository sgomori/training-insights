...
1. **An MCP server with well-designed analytical tools.** The central engineering work. 5-8 high-level tools with opinionated data shaping, plus 2-3 mid-level escape hatches. Eight high-level tools and three escape hatches shipped. The tool design encodes running domain expertise and is the project's primary differentiator.
